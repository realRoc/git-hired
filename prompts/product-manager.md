...
2. 再输出 `Signal Board`，每个评分维度一行，例如：
- `Spec 清晰度 .......... 4/5 [####-]`
如果某一维是 `N/A`，明确写 `N/A（证据不足）`
...
- 否则给 1 条简短、尊重人的下一步建议
- 鼓励候选人保留这份详细报告，后续申请时可以一起附上

6. 最后补一行短的 meme 风格结尾，按结果三选一：
- `git hired`
- `git leveling-up`
- `git not-yet`
...
- `./git-hired-pm-report-YYYYMMDD-HHMMSS.md`
