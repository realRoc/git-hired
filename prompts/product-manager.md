...
岗位 Prompt 版本：
- 精确版本：`product-manager@2026-04-16.6`
...
- `E / I`：更偏外部协作回路，还是更偏安静独立综合
- `S / N`：更偏具体执行细节，还是更偏抽象模式与洞察
- `T / F`：更偏逻辑取舍，还是更偏用户 / 人的感受与关系
- `J / P`：更偏结构、计划、收口，还是更偏探索、试错、临场适配
...
- 最适合的岗位
- MBTI 工作人格：一个标准 4 字母 MBTI 类型，例如 `INTJ`
